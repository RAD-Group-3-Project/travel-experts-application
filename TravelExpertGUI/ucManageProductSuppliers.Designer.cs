...
partial class ucManageProductSuppliers
{
    ...
    private void InitializeComponent()
    {
        ...
        txtProductSupplierId.Location = new Point(212, 57);
        ...
        cboProductName.Location = new Point(212, 105);
        cboProductName.Margin = new Padding(3, 4, 3, 4);
        cboProductName.Name = "cboProductName";
        cboProductName.Size = new Size(100, 28);
        ...
        cboSupplierName.Location = new Point(212, 153);
        cboSupplierName.Margin = new Padding(3, 4, 3, 4);
        cboSupplierName.Name = "cboSupplierName";
        cboSupplierName.Size = new Size(100, 28);
        ...
        dgvProductSupplier.Location = new Point(48, 205);
        dgvProductSupplier.Name = "dgvProductSupplier";
        dgvProductSupplier.RowHeadersWidth = 51;
        dgvProductSupplier.Size = new Size(704, 149);
